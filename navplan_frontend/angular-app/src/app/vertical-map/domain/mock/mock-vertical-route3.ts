...
export class MockVerticalRoute3 {
    ...
    public static WPS2 = MockWpStepBuilder.aStepAltDistWp(0, 40, this.WP2).build();
    public static TS1 = MockTerrStepBuilder.aStepElevDist(0, 0).build();
    public static TS2 = MockTerrStepBuilder.aStepElevDist(6000, 25).build();
    public static TS3 = MockTerrStepBuilder.aStepElevDist(4000, 30).build();
    public static TS4 = MockTerrStepBuilder.aStepElevDist(2000, 35).build();
    public static TS5 = MockTerrStepBuilder.aStepElevDist(0, 40).build();
    public static CRUISE_ALT = Length.ofFt(7000);
