...
import {IRestOgnTrafficResponse} from '../model/i-rest-ogn-traffic-response';
import {RestOgnTrafficResponseConverter} from '../model/rest-ogn-traffic-response-converter';
