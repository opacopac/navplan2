...
import {UserProfilePageComponent} from './user/view/ng-components/user-profile/user-profile-page/user-profile-page.component';
import {FlightMapPageComponent} from './flight-map/view/ng-components/flight-map-page/flight-map-page.component';
import {LoginRegisterPageComponent} from './user/view/ng-components/user-profile/login-register-page/login-register-page.component';
import {RegisterStep2PageComponent} from './user/view/ng-components/user-profile/register-step2-page/register-step2-page.component';
import {ForgotPwStep1PageComponent} from './user/view/ng-components/user-profile/forgot-pw-step1-page/forgot-pw-step1-page.component';
...
import {PlanTabsComponent} from './plan/plan-tabs/view/ng-components/plan-tabs/plan-tabs.component';
