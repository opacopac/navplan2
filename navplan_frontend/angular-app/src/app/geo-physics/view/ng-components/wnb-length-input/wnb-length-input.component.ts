...
export class WnbLengthInputComponent extends AbstractQuantityInputComponent<Length, LengthUnit> {
    ...
    protected override get availableUnits(): LengthUnit[] {
        return NavplanUnits.wnbLengthUnits;
    }
