...
export class LocationEffects {
    ...
    toggleLocationWatch$: Observable<Action> = createEffect(() => this.actions$.pipe(
    ...
    startLocationWatch$: Observable<Action> = createEffect(() => this.actions$.pipe(
        ofType(LocationActions.startWatching),
        tap(() => this.locationService.startWatching()),
        switchMap(() => {
            return this.locationService.position$.pipe(
    ...
    stopLocationWatch$: Observable<Action> = createEffect(() => this.actions$.pipe(
