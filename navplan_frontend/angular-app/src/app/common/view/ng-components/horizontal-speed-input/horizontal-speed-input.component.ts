...
@Component({
    ...
    templateUrl: './horizontal-speed-input.component.html',
    styleUrls: ['./horizontal-speed-input.component.scss']
})
export class HorizontalSpeedInputComponent implements OnInit, OnChanges {
