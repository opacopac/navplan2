...
class AirportDbRepo implements IAirportRepo {
    private $dbService;
    ...
    private function readAirportFromResult(array $rs): Airport {
        return new Airport(
            intval($rs["id"]),
            $rs["type"],
            $rs["name"],
    ...
    private function readAirportRunwayFromResult(array $rs): AirportRunway {
    ...
    private function readAirportRadioFromResult(array $rs): AirportRadio {
    ...
    private function readAirportChartFromResult(array $rs): array {
        return array(
            "id" => $rs["id"],
            "source" => $rs["source"],
            "type" => $rs["type"],
    ...
    private function readAirportFeatureFromResult(array $rs): MapFeature {
