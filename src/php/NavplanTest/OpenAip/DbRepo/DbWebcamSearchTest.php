...
use Navplan\OpenAip\DbRepo\DbWebcamSearch;
...
class DbWebcamSearchTest extends TestCase {
    private $dbService;
    private $dbRepo;
    ...
    private function getDbRepo(): DbWebcamSearch {
        return $this->dbRepo;
    }
    ...
    protected function setUp(): void {
        ...
        $this->dbRepo = new DbWebcamSearch($this->getDbService());
    }
