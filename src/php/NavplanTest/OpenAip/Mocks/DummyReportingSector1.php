...
class DummyReportingSector1 {
    public static function create(): ReportingPoint {
        return new ReportingPoint(
            ...
            NULL,
            NULL,
            Polygon::createFromArray([[7.0282, 46.7227], [7.0486, 46.7382], [7.0894, 46.7328], [7.0952, 46.7168], [7.0808, 46.7137], [7.0661, 46.7128], [7.0513, 46.7143], [7.0394, 46.7176], [7.0282, 46.7227]])
        );
    }
