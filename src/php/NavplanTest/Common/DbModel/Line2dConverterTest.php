...
class Line2dConverterTest extends TestCase {
    public function test_toWktLineString() {
        ...
        $result1 = DbLine2dConverter::toWktLineString($line2d);
        $result2 = DbLine2dConverter::toWktLineString($line2d, false);
    ...
    public function test_toWktMultilineString() {
        ...
        $result1 = DbLine2dConverter::toWktMultilineString([$line1, $line2]);
        $result2 = DbLine2dConverter::toWktMultilineString([$line1, $line2], false);
    ...
    public function test_fromWktMultiLineString() {
        ...
        $result = DbLine2dConverter::fromWktMultiLineString($multiLineString);
