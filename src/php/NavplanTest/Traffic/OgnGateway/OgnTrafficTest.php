...
use Navplan\Traffic\OgnGateway\OgnTraffic;
...
class OgnTrafficTest extends TestCase {
    ...
    public function test_fromResponse() {
        ...
        $ac1 = OgnTraffic::fromDumpFileLine($ognLine1, $this->timeService);
        $ac2 = OgnTraffic::fromDumpFileLine($ognLine2, $this->timeService);
        $ac3 = OgnTraffic::fromDumpFileLine($ognLine3, $this->timeService);
        $ac4 = OgnTraffic::fromDumpFileLine($ognLine4, $this->timeService);
        $ac5 = OgnTraffic::fromDumpFileLine($ognLine5, $this->timeService);
