...
use Navplan\Geoname\DbRepo\GeonameDbRepo;
...
class GeonameDbRepoTest extends TestCase {
    private $dbService;
    private $dbRepo;
    ...
    private function getDbRepo(): GeonameDbRepo {
        return $this->dbRepo;
    }
    ...
    protected function setUp(): void {
        ...
        $this->dbRepo = new GeonameDbRepo($this->getDbService());
    }
