...
xdescribe('OgnTrafficService', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            providers: [OgnTrafficService]
        });

        httpMock = TestBed.get(HttpTestingController);
        trafficOgnService = TestBed.get(OgnTrafficService);
    });
