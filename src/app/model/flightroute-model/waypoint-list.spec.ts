...
describe('WaypointList', () => {
    ...
    it('correctly sets the waypoint speeds', () => {
        Observable.combineLatest(
            wpList.items$.flatMap(items => items[0].speed$),
            wpList.items$.flatMap(items => items[1].speed$),
            wpList.items$.flatMap(items => items[2].speed$),
            wpList.items$.flatMap(items => items[3].speed$)
        )
    ...
    it('correctly sets the alternate speed', () => {
        wpList.alternate = wp5;
        wpList.alternate$.flatMap(alt => alt.speed$)
            .subscribe((altSpeed) => {
    ...
    it('correctly sets the waypoint dependencies (wp1 prev)', () => {
        wpList.items$.flatMap(items => items[0].previousWaypoint$)
            .subscribe((wp1prev) => {
    ...
    it('correctly sets the waypoint dependencies (wp1 next)', () => {
        wpList.items$.flatMap(items => items[0].nextWaypoint$)
            .subscribe((wp1next) => {
    ...
    it('correctly sets the waypoint dependencies (wp4 prev)', () => {
        wpList.items$.flatMap(items => items[3].previousWaypoint$)
            .subscribe((wp4prev) => {
    ...
    it('correctly sets the waypoint dependencies (wp4 next)', () => {
        wpList.items$.flatMap(items => items[3].nextWaypoint$)
            .subscribe((wp4next) => {
    ...
    it('correctly sets the alternate dependencies (alt prev)', () => {
        wpList.alternate = wp5;
        wpList.alternate$.flatMap(alternate => alternate.previousWaypoint$)
            .subscribe((altPrev) => {
