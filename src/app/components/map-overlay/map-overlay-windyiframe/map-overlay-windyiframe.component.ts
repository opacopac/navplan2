...
@Component({
    selector: 'app-map-overlay-windyiframe',
    templateUrl: './map-overlay-windyiframe.component.html',
    styleUrls: ['./map-overlay-windyiframe.component.css']
})
export class MapOverlayWindyiframeComponent implements OnInit {
