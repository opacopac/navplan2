...
class MySqlDbInsertCommandBuilderTest extends TestCase
{
    ...
    public function test_insert_into()
    {
        ...
        $qb = $this->insertCommandBuilder
            ->insertInto($t)
            ->setColValue($c1, "value1")
            ->setColValue($c2, 123)
            ->setColValue($c3, 45.67)
            ->setColValue($c4, true);
    ...
    public function test_build_bind_statement_types()
    {
        ...
        $qb = $this->insertCommandBuilder
            ...
            ->setColValue($c3, 45.67)
            ->setColValue($c4, true)
            ->setColValue($c5, "2023-10-01 12:00:00")
            ->setColValue($c6, "POINT(1 2)")
            ->setColValue($c7, "LINESTRING(1 2, 3 4)")
            ->setColValue($c8, "POLYGON((1 2, 3 4, 5 6, 1 2))")
            ->setColValue($c9, "MULTIPOLYGON(((1 2, 3 4, 5 6, 1 2)))");
    ...
    public function test_build_prepared_statement_for_geo_types()
    {
        ...
        $qb = $this->insertCommandBuilder
            ->insertInto($t)
            ->setColValue($c1, "value1")
            ->setColValue($c2, "POINT(1 2)")
            ->setColValue($c3, "LINESTRING(1 2, 3 4)")
            ->setColValue($c4, "POLYGON((1 2, 3 4, 5 6, 1 2))")
            ->setColValue($c5, "MULTIPOLYGON(((1 2, 3 4, 5 6, 1 2)))");
