...
interface IDbQueryBuilder
{
    ...
    function whereEquals(DbCol|string $column, string|int|float|bool|null|DbExp|DbCol $value): IDbQueryBuilder;

    function groupBy(DbCol|string $column): IDbQueryBuilder;
