...
class DbTableAirportCharts extends DbTable
{
    ...
    public function __construct(string $alias = null)
    {
        ...
        $this->addCol(self::COL_SOURCE, DbColType::STRING, true);
        $this->addCol(self::COL_NAME, DbColType::STRING, true);
        $this->addCol(self::COL_ACTIVE, DbColType::BOOL, true);
        $this->addCol(self::COL_FILENAME, DbColType::STRING, true);
        ...
        $this->addCol(self::COL_IMPORT_CHECKSUM, DbColType::STRING, true);
