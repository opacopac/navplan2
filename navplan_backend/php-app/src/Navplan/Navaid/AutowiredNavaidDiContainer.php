...
/**
 * POC: replaces the manual, hand-written lazy-init getters of ProdNavaidDiContainer
 * (133 lines) with a PHP-DI autowiring container (~45 lines).
 *
 ...
 */
class AutowiredNavaidDiContainer implements INavaidDiContainer
{
